...
public class DownloadsDialogFragment extends DialogFragment {
    ...
    public static void showDialog(AppCompatActivity activity) {
        ...
        Fragment prev = fragmentManager.findFragmentByTag(DownloadsDialogFragment.TAG);
        if (prev != null) {
            ft.remove(prev);
        }
        DialogFragment dialogFragment = new DownloadsDialogFragment();
        dialogFragment.show(activity.getSupportFragmentManager(), DownloadsDialogFragment.TAG);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View downloadsEmptyView = rootView.findViewById(R.id.downloads_dialog_entries_empty);
        ...
        downloadsEmptyView.setVisibility(View.VISIBLE);
