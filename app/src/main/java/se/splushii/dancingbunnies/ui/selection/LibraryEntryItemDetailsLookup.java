...
public class LibraryEntryItemDetailsLookup extends ItemDetailsLookup<LibraryEntry> {
    private final RecyclerView recyclerView;

    public LibraryEntryItemDetailsLookup(RecyclerView recyclerView) {
        this.recyclerView = recyclerView;
    }

    @Nullable
    @Override
    public ItemDetails<LibraryEntry> getItemDetails(@NonNull MotionEvent e) {
